...
<div class="rumah-sakit-form">
    ...
    <?= $form->field($model, 'nama_rumah_sakit')->textInput(['maxlength' => true]) ?>
    ...
    <?php if (!$model->isNewRecord): ?>
        ...
        if (!empty($model->foto)){
                ...
                $img[] = Html::img($url.'/web/gambar/rumahsakit/'.$model->foto, ['style' => 'width:auto; height:auto; max-width:100%; max-height:100%']);

                $json[] = [
                    'caption'=>$model->foto, Url::to(['/file/delete-upload']),
                      'key' => 'foto '.  $model->id_rumah_sakit, 
                ];
            }
        ?>
