...
/* @var $model app\models\DokterPraktek */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="dokter-praktek-form">

    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'nama_dokter_praktek')->textInput(['maxlength' => true]) ?>
    ...
    <?php if (!$model->isNewRecord): ?>
        ...
        if (!empty($model->foto)){
                ...
                $img[] = Html::img($url.'/web/gambar/dokterpraktek/'.$model->foto, ['style' => 'width:auto; height:auto; max-width:100%; max-height:100%']);

                $json[] = [
                    'caption'=>$model->foto, Url::to(['/file/delete-upload']),
                      'key' => 'foto '.  $model->id_dokter_praktek, 
                ];
            }
        ?>
