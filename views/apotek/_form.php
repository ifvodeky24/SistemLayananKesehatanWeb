...
<div class="apotek-form">

    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'nama_apotek')->textInput(['maxlength' => true]) ?>
    ...
    <?php if (!$model->isNewRecord): ?>
        ...
        if (!empty($model->foto)){
                ...
                $img[] = Html::img($url.'/web/gambar/apotek/'.$model->foto, ['style' => 'width:auto; height:auto; max-width:100%; max-height:100%']);

                $json[] = [
                    'caption'=>$model->foto, Url::to(['/file/delete-upload']),
                      'key' => 'foto '.  $model->id_apotek, 
                ];
            }
        ?>
