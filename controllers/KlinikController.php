...
class KlinikController extends Controller
{
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                if($model->foto){
                    ...
                    if ($model->foto->saveAs('gambar/klinik/'.$file) ){
                        $model->foto = $file;           
                    }
                }
                $model->save(false);
                return [
                    ...
                    'title'=> "Klinik",
                    'content'=>'<span class="text-success">Create Klinik success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->id_klinik]);
            } else {
    ...
    /**
     * Delete an existing Klinik model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Klinik model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
